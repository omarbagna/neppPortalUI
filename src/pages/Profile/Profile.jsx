		...
		<div>
			<div className="relative w-full h-44 lg:h-72 lg:pl-36 bg-gray flex flex-col justify-end gap-3 lg:flex-row lg:justify-around items-end overflow-hidden">
				<img
					...
					alt="cover"
				/>
				<div className="w-full h-full md:h-2/3 bg-gradient-to-l from-black z-10 md:bg-gradient-to-t flex flex-col justify-end gap-3 p-4 lg:pb-6 md:px-8 lg:px-10 md:flex-row md:justify-between items-end">
			...
			<div className="relative h-full lg:h-screen w-full z-20 py-14 flex flex-col gap-10 lg:gap-20 justify-start items-start mt-4 mb-8 sm:mb-20  lg:pl-44 lg:my-0 p-4 sm:p-8 lg:pr-16 ">
				...
				<div className="w-full h-fit flex flex-col gap-6 lg:flex-row lg:gap-10 justify-start items-start lg:justify-center">
					<ProfileCard
